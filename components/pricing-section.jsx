      ...
      <div className="glass-panel rounded-[2rem] p-8">
        <div className="grid gap-8 xl:grid-cols-[0.8fr_1.2fr]">
          <div className="max-w-3xl">
            ...
            <p className="mt-4 text-sm leading-7 text-base-content/74">
              Pick a plan, start with a small seat count, and adjust later as more teammates join the workspace.
            </p>

            <div className="mt-6 rounded-[1.25rem] border border-white/8 bg-white/[0.03] p-4 md:max-w-md">
              <label className="form-control">
                <div className="label pb-2">
                  <span className="label-text text-base-content/86">How many members are you planning to invite?</span>
                </div>
                <input
          ...
          <div>
            {checkoutError ? <AlertBanner tone="error" className="mb-6">{checkoutError}</AlertBanner> : null}
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              {plans.map((plan) => {
                ...
                return (
                  <div
                    key={plan.key}
                    className={`flex flex-col rounded-[1.7rem] border p-6 ${
                      isAnnual
                        ? "border-secondary/65 bg-[linear-gradient(160deg,rgba(9,18,34,0.98),rgba(7,13,26,0.94))] shadow-soft"
                  ...
                  >
                    ...
                    <div className="mt-3 text-sm leading-7 text-base-content/72">
                    ...
                    <div className="mt-6 rounded-[1.2rem] border border-white/8 bg-black/20 p-4">
                      <div className="text-xs uppercase tracking-[0.2em] text-base-content/56">Estimated total</div>
