...
export function getResendFromAddress() {
  return process.env.AUTH_RESEND_FROM ?? "Collato.io <hello@resend.collato.io>";
}

export function getResendReplyTo() {
  return process.env.RESEND_REPLY_TO ?? "support@collato.io";
}
    ...
    html: `
      <div style="background:#f4fbff;padding:32px 16px;font-family:Arial,sans-serif;color:#18324a;">
        <div style="max-width:560px;margin:0 auto;background:#ffffff;border-radius:24px;padding:32px;border:1px solid #d9e7f2;">
          <div style="font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#169cb0;font-weight:700;">Collato.io</div>
