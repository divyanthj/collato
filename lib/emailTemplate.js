    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;border-collapse:collapse;background-color:#f4fbff;margin:0;padding:0;">
      <tr>
        <td align="center" style="padding:32px 16px;">
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="560" style="width:100%;max-width:560px;border-collapse:separate;background-color:#ffffff;border:1px solid #d9e7f2;border-radius:24px;">
            <tr>
              <td style="padding:32px;font-family:Arial,sans-serif;color:#18324a;">
                <p style="margin:0;font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#169cb0;font-weight:700;">${safeKicker}</p>
                <h1 style="margin:16px 0 12px;font-size:30px;line-height:1.1;font-weight:700;color:#18324a;">${safeTitle}</h1>
                <p style="margin:0 0 18px;line-height:1.7;color:#385065;font-size:16px;">${safeIntro}</p>
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;">
                  <tr>
                    <td bgcolor="#2976df" style="border-radius:14px;background-color:#2976df;">
                      <a href="${safeCtaUrl}" style="display:inline-block;padding:14px 20px;font-family:Arial,sans-serif;font-size:15px;font-weight:700;line-height:1.2;color:#ffffff;text-decoration:none;border-radius:14px;">
                        ${safeCtaLabel}
                      </a>
                    </td>
                  </tr>
                </table>
                <p style="margin:18px 0 0;line-height:1.7;color:#5c7084;font-size:15px;">${safeFallbackLabel}</p>
                <p style="margin:8px 0 0;word-break:break-all;color:#2976df;font-size:15px;line-height:1.5;">${safeFallbackUrl}</p>
  ...
  return {
    ...
    html: `
      <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%;border-collapse:collapse;background-color:#f4fbff;margin:0;padding:0;">
        <tr>
          <td align="center" style="padding:32px 16px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:100%;max-width:640px;border-collapse:separate;background-color:#ffffff;border:1px solid #d9e7f2;border-radius:24px;">
              <tr>
                <td style="padding:32px;font-family:Arial,sans-serif;color:#18324a;">
                  <p style="margin:0;font-size:12px;letter-spacing:0.24em;text-transform:uppercase;color:#169cb0;font-weight:700;">${escapeHtml(appName)} digest</p>
                  <h1 style="margin:16px 0 12px;font-size:30px;line-height:1.1;font-weight:700;color:#18324a;">${totalUpdates} new update${totalUpdates === 1 ? "" : "s"} across ${workspaceCount} workspace${workspaceCount === 1 ? "" : "s"}</h1>
                  <p style="margin:0 0 16px;line-height:1.7;color:#385065;font-size:16px;">Here is your daily roundup of workspace activity.</p>
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-collapse:separate;">
                    <tr>
                      <td bgcolor="#2976df" style="border-radius:14px;background-color:#2976df;">
                        <a href="${escapeAttribute(digestUrl)}" style="display:inline-block;padding:14px 20px;font-family:Arial,sans-serif;font-size:15px;font-weight:700;line-height:1.2;color:#ffffff;text-decoration:none;border-radius:14px;">
                          Open Collato
                        </a>
                      </td>
                    </tr>
